          ...
          <div className="container">
            <div className="max-w-4xl">
              ...
              <div className="hero-anim flex flex-wrap items-center gap-4">
                ...
                <a
                  href="https://www.instagram.com/capodilagobistrot/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 flex items-center justify-center border border-white/30 text-white hover:bg-white hover:text-[var(--navy)] transition-all"
